...
export type SFMThunk<ReturnType = void> = ThunkAction<
  ReturnType,
  IFileManagerState,
  null,
  Action<string>
...
export type SFMDispatch = ThunkDispatch<IFileManagerState, null, Action<string>>;
