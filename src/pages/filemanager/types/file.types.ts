...
import { SFMIconName } from './icons.types';
...
export interface FileData {
  ...
  icon?: SFMIconName | string | any; // Icon to use for this file
  fullUrl?: string;
  thumbnailUrl?: string; // Automatically load thumbnail from this URL
  folderChainIcon?: Nullable<SFMIconName | string | any>; // Folder chain icon
