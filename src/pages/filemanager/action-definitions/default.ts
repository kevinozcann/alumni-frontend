...
export const DefaultActions = {
  ...
  SelectAllFiles: defineFileAction({
    ...
    button: {
      ...
      contextMenu: true,
      group: 'Actions',
      icon: SFMIconName.selectAllFiles
    },
    selectionTransform: (({ fileIds, hiddenFileIds }) => {
      const newSelection = new Set<string>();
      fileIds.map((fileId) => {
        // We don't need to check if file is selectable because SFM does
  ...
  ClearSelection: defineFileAction({
    ...
    button: {
      ...
      contextMenu: true,
      group: 'Actions',
      icon: SFMIconName.clearSelection
    },
  ...
  EnableGridView: defineFileAction({
    ...
    button: {
      ...
      toolbar: true,
      icon: SFMIconName.smallThumbnail,
      iconOnly: true
    }
  } as const),
  /**
