...
import { c, getStripeGradient, makeGlobalSFMStyles, makeLocalSFMStyles } from '../../util/styles';
    ...
    >
      <div className={localClasses.dndDropZone}>
        <div className={localClasses.dndDropZoneIcon}>
          <SFMIcon icon={dndCanDrop ? SFMIconName.dndCanDrop : SFMIconName.dndCannotDrop} />
        </div>
      </div>
...
const useLocalStyles = makeLocalSFMStyles((theme) => ({
  fileListWrapper: {
    minHeight: SFMActions.EnableGridView.fileViewConfig.entryHeight + 2,
