...
const BasicStats = (props: TBasicStatsProps) => {
  ...
  const { numberOfUsers, numberOfStudents, dailyCash, dailyEnrollments } =
    basicStats;
  ...
  const [basicStatsMenuElt, setBasicStatsMenuElt] =
  ...
  return (
    <Card>
      ...
      <CardContent
        sx={{ p: 0, m: 0, paddingBottom: "0 !important", position: "relative" }}
      >
        <Box sx={{ fontFamily: fontFamily, height: 200, bgcolor: "#F64E60" }}>
          {chartData &&
            dailyCashStatsPhase ===
              dailyCashActionPhases.PULLING_SUCCESSFUL && (
