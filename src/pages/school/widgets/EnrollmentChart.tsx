...
import { faCalendarAlt, faChevronDown } from '@fortawesome/pro-duotone-svg-icons';
...
const mapDispatchToProps = (dispatch: AppDispatch) => ({
  pullEnrollmentStats: (lang: TLang, schoolId: number, period: string) =>
    dispatch(enrollmentStatsActions.pullEnrollmentStats(lang, schoolId, period))
});
...
const EnrollmentChart = (props: TEnrollmentChartProps) => {
  ...
  return (
    <Widget
      ...
      subheader={intl.formatMessage({ id: 'dashboard.enrollment.stats_description' })}
      action={
